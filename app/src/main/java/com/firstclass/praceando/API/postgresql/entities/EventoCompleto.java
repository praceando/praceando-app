...
public class EventoCompleto implements Parcelable {
    private long id;
    ...
    public EventoCompleto(long id, Locale local, int qtInteresse,
    ...
    protected EventoCompleto(Parcel in) {
    ...
    public static final Creator<EventoCompleto> CREATOR = new Creator<EventoCompleto>() {
        @Override
        public EventoCompleto createFromParcel(Parcel in) {
            return new EventoCompleto(in);
        }

        @Override
        public EventoCompleto[] newArray(int size) {
            return new EventoCompleto[size];
        }
    };
